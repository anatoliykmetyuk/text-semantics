...
def _run():
  ...
  X, y, converter = prims.one_hot_txt(raw, 10)
  # y = prims.shift(y, 1)
  ...
  l2  = GRU(enc_length, activation='relu')(inp)

  rc = RecurrentContainer(decode=True, output_length=X_train.shape[1])
  rc.add(GRUCell(converter.embeddingLen, input_dim=enc_length, activation='softmax'))
  l3 = rc(l2)
